...
function getResizedImage(imageUrl: string, sizeOption: string): Promise<string> {
...
export default async function resizeImageAsync(imageUrl: string, sizeOption: string): Promise<any> {
